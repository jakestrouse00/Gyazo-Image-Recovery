...
class Recover:
    def __init__(self, username, password, country_code):
        self.username = str(username)
        self.password = str(password)
        self.contry_code = str(country_code).lower()
    ...
    def getSession(self):
        ...
        payload = {"email": self.username, "origin": 'null', "password": self.password, "country": self.contry_code}
        # the post request
        ...
        for cookie in r.cookies:
            try:
                ...
                pass
        self.session = f"Gyazo_session={session}"
